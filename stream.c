 ...
 *     The environment variable OMP_NUM_THREADS allows runtime control of
 *       the number of threads/cores used when the resulting "stream_omp"
 *       program is executed.
 *
 *     To run with single-precision variables and arithmetic, simply add
 *       -DSTREAM_TYPE=float to the compile line.
